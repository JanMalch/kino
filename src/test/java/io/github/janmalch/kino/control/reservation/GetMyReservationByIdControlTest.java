...
public class GetMyReservationByIdControlTest {
  ...
  public void testExecuteValid() {
    ...
    var control = new GetMyReservationByIdControl(existingReservation.getId(), accountName);
  ...
  public void testExecuteInvalid() {
    var existingReservation = util.provideNewReservation(accountName, presentation.getId());
    var control = new GetMyReservationByIdControl(existingReservation.getId(), "fail@expected.com");
